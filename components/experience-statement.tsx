  ...
  return <section ref={root} className={styles.root} aria-labelledby="experience-statement-title">
    ...
    <figure className={styles.photo} data-experience-motion="photo">
      <Image
        ...
        alt="Dra. Ingrid Andrade em retrato com conjunto em tons de marrom"
        fill
      ...
      <p className={styles.photoCopy} data-experience-motion="photo-copy">ELEGÂNCIA<br />EM CADA<br />DETALHE.<span aria-hidden="true" /></p>
      <ImageSeal id={uid} />
    </figure>
    ...
    <blockquote className={styles.quote} data-experience-motion="quote">
      ...
      <div>
        <p>Beleza e autocuidado<br />com propósito.</p>
        <footer><span aria-hidden="true" /><cite>INGRID ANDRADE</cite></footer>
      </div>
    </blockquote>
