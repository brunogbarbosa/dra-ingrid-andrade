  ...
  return <section id="manifesto" className="essence-editorial" ref={root} aria-labelledby="essence-title">
    <div className="essence-stage">
      ...
      <svg className="essence-thread essence-thread-desktop" viewBox="0 0 1440 740" fill="none" aria-hidden="true">
        <defs><radialGradient id={`${uid}-pearl`} cx="30%" cy="25%"><stop stopColor="#faf0e1"/><stop offset=".5" stopColor="#b99b75"/><stop offset="1" stopColor="#694735"/></radialGradient></defs>
      ...
      <svg className="essence-thread essence-thread-mobile" viewBox="0 0 400 900" fill="none" aria-hidden="true">
        <defs><radialGradient id={`${uid}-pearl-mobile`} cx="30%" cy="25%"><stop stopColor="#faf0e1"/><stop offset=".5" stopColor="#b99b75"/><stop offset="1" stopColor="#694735"/></radialGradient></defs>
      ...
      <figure className="essence-smile" data-essence-motion="photo">
        <Image src="/images/ingrid-detalhe.webp" alt="Detalhe de lábios em registro da Dra. Ingrid Andrade." fill sizes="(max-width:700px) 88vw, 45vw"/>
      </figure>
      ...
      <div className="essence-editorial-copy">
        ...
        <p className="essence-editorial-description" data-essence-motion="fade" data-delay="350">A sua beleza tem uma identidade. Valorizar seus traços é respeitar sua expressão, suas proporções e tudo o que torna você única.</p>
